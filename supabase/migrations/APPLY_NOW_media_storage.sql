-- Public media bucket (avatars, covers, posts, stories, chat).
-- Run in Supabase → SQL Editor if the dated migration is not applied yet.
...
-- List avatars without shipping data-URL blobs (PostgREST egress).
